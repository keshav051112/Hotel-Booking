...
const AddRoom = () => {
  ...
  return (
    <form>
      <Title align='left' font='outfit' title='Add Room' subTitle="Fill in the details craefully and accurate room details ,pricing,and amenities,to enhance the user booking experience"/>
